...
const Settings = () => {
    ...
    return (
        <div className='fixed bottom-[72px] right-6'>
            <div onClick={() => { setshowSettings(!showSettings) }} className={`fixed bottom-4 right-4 transition duration-500 shadow-md ${showSettings ? "bg-blue-500" : "bg-blue-200"} rounded-full p-2 z-10`}>
